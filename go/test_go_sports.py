...
class SportsSchemaTests(unittest.TestCase):
    ...
    def test_html_previa_uses_real_sports_fields_only(self):
        ...
        self.assertIn("sportsLine", html)
        self.assertIn("Sin partidos de la lista hoy.", html)
        self.assertIn("e.hora_madrid", html)
        self.assertIn("e.canal", html)
        self.assertIn("sportTitle", html)
        self.assertIn("sportFuente", html)
        self.assertIn("sportText", html)
        self.assertNotIn("${safe(e.evento)}", html)
        self.assertNotIn("${safe(e.fuente)}", html)
        self.assertNotIn("${safe(e.competicion)}", html)
        self.assertNotIn('href="${safe(e.fuente)}"', html)
        mjs = (ROOT / "sports.mjs").read_text(encoding="utf-8")
        self.assertIn("partido", mjs)
        self.assertIn("sportTitle", mjs)
        self.assertIn("sportText(e?.partido) || sportText(e?.evento)", mjs)
        ...
        self.assertIn("Interés ${safe(interesN)} · ${safe(motivo)}", html)
        self.assertIn("sports-tag", html)
        self.assertIn("sports-tag-futbol", html)
        self.assertIn("sports-tag-beisbol", html)
        self.assertIn("sports-tag-americano", html)
        self.assertIn("sports-tag-f1", html)
        self.assertIn("sports-fav", html)
        self.assertIn("sports-star-4", html)
        self.assertIn("sports-star-5", html)
        self.assertIn("from './sports.mjs?v=", html)
        self.assertIn("sportKind", html)
        self.assertIn("sports-tag-hockey", html)
        self.assertIn("deporte-dia", html)
        self.assertIn("sportsOnDay", html)
        self.assertIn("sportsCardLine", html)
        self.assertIn("casaDocOpt('go_sports_week')", html)
        self.assertIn("sportsOnDay(sportsWeekData,day.date)", html)
        self.assertNotIn("sportsOnDay(sportsData,day.date)", html)
        put = (ROOT / "casa_put_json.py").read_text(encoding="utf-8")
        self.assertIn('"go/sports.json": "go_sports"', put)
        self.assertIn('"go/sports_week.json": "go_sports_week"', put)
        self.assertIn("isHouseFav", html)
        self.assertIn("matchHouseFav(sportTitle(e)", html)
        self.assertIn("parseFavoritos", html)
        self.assertIn("go_favoritos", html)
        self.assertNotIn("/Real Madrid/i.test(name)", html)
        self.assertIn("function canalHomeUrl", html)
        self.assertIn("function canalMark", html)
        self.assertIn("https://www.dazn.com", html)
        self.assertIn("https://www.disneyplus.com", html)
        self.assertIn("https://www.mlb.com", html)
        self.assertIn('target="_top"', html)
        self.assertNotIn("dazn://", html)
        self.assertNotIn("/Brewers/i.test(a.evento)", html)
        self.assertNotIn("sportsOrder", html)
