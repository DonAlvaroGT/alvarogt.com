...
export const TIEMPO_URL = 'https://api.open-meteo.com/v1/forecast?latitude=40.4168&longitude=-3.7038&daily=temperature_2m_min,temperature_2m_max,precipitation_probability_max&timezone=Europe%2FMadrid&forecast_days=14&past_days=6';
