...
class GoClientAuthHtmlTests(unittest.TestCase):
    ...
    def test_data_from_firestore_after_start_app(self):
        ...
        self.assertIn("from './trip_line.mjs?v=20260916d'", self.html)
        self.assertIn("from './comedor.mjs?v=20260916d'", self.html)
        self.assertIn("from './stamp.mjs?v=20260916d'", self.html)
        self.assertIn("from './vista.mjs?v=20260916d'", self.html)
