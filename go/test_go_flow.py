...
class GoClientAuthHtmlTests(unittest.TestCase):
    ...
    def test_data_from_firestore_after_start_app(self):
        ...
        self.assertIn("casaDoc('viajes')", self.html)
        self.assertIn("casaDoc('go_comedor')", self.html)
        self.assertIn("from './trip_line.mjs'", self.html)
        self.assertIn("from './comedor.mjs'", self.html)
